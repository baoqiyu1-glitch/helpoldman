...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"助老助残系统","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!****************************************************!*\
  !*** D:/毕业设计/源码/helpoldman/miniprogram/pages.json ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
var appid = "__UNI__E7E511F"; // 做应用隔离
...
/* 32 */
/*!*********************************************************************!*\
  !*** D:/毕业设计/源码/helpoldman/miniprogram/pages.json?{"type":"style"} ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  "pages": {
    ...
    "pages/elder/emergency-alert": {
      "navigationBarTitleText": "紧急报警"
    },
    "pages/elder/profile": {
      "navigationBarTitleText": "个人档案"
    },
    "pages/elder/shopping": {
      "navigationBarTitleText": "代购生活物资"
    },
    "pages/elder/housework": {
      "navigationBarTitleText": "上门协助家务"
    },
    "pages/elder/equipment": {
      "navigationBarTitleText": "辅助器具申请"
    },
    "pages/elder/barrier-free": {
      "navigationBarTitleText": "无障碍改造申请"
    },
    "pages/elder/training": {
      "navigationBarTitleText": "技能培训"
    },
    "pages/elder/community": {
      "navigationBarTitleText": "社区互助"
    },
    "pages/family/donation": {
      "navigationBarTitleText": "爱心捐赠"
    },
    "pages/family/learn": {
      "navigationBarTitleText": "我要学习"
    },
    "pages/family/nurse": {
      "navigationBarTitleText": "申请护工"
    },
    "pages/family/meal": {
    ...
    "pages/family/housework": {
      "navigationBarTitleText": "协助家务"
    },
    ...
    "pages/volunteer/profile": {
      "navigationBarTitleText": "个人档案"
    },
    "pages/volunteer/shopping": {
      "navigationBarTitleText": "代购物资"
    },
    "pages/volunteer/housework": {
      "navigationBarTitleText": "协助家务"
    },
...
/* 41 */
/*!**********************************************************!*\
  !*** D:/毕业设计/源码/helpoldman/miniprogram/utils/requset.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

/* WEBPACK VAR INJECTION */(function(uni) {var _regeneratorRuntime = __webpack_require__(/*! @babel/runtime/regenerator */ 42);
var _slicedToArray = __webpack_require__(/*! @babel/runtime/helpers/slicedToArray */ 5);
var _defineProperty = __webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11);
var _asyncToGenerator = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ 44);
var _classCallCheck = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ 23);
var _createClass = __webpack_require__(/*! @babel/runtime/helpers/createClass */ 24);
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { _defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
var config = __webpack_require__(/*! ../config */ 45);
  ...
  _createClass(Request, [{
    ...
    value: function () {
      var _request = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(options) {
        var url, _options$method, method, _options$data, data, _options$header, header, fullURL, headers, response, _response, error, res, statusCode, result;
        return _regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                url = options.url, _options$method = options.method, method = _options$method === void 0 ? 'GET' : _options$method, _options$data = options.data, data = _options$data === void 0 ? {} : _options$data, _options$header = options.header, header = _options$header === void 0 ? {} : _options$header; // 拼接完整URL
                fullURL = this.baseURL + url; // 设置请求头
              ...
              case 12:
                statusCode = res.statusCode, result = res.data;
                if (!(statusCode === 401)) {
                  _context.next = 18;
                  break;
                }
                ...
                return _context.abrupt("return", Promise.reject(new Error('登录已过期')));
              case 18:
                if (!(statusCode !== 200)) {
                  _context.next = 21;
                  break;
                ...
                return _context.abrupt("return", Promise.reject(new Error(result.message || '请求失败')));
              case 21:
                if (!(result.code !== 200)) {
                  _context.next = 24;
                  break;
...
/* 45 */
/*!***************************************************!*\
  !*** D:/毕业设计/源码/helpoldman/miniprogram/config.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
