...
var _equipment = _interopRequireDefault(__webpack_require__(/*! ./pages/elder/equipment.vue */ 120));
// @ts-ignore
...
/* harmony import */ var _equipment_vue_vue_type_template_id_459c23e0_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./equipment.vue?vue&type=template&id=459c23e0&scoped=true& */ 121);
/* harmony import */ var _equipment_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./equipment.vue?vue&type=script&lang=js& */ 123);
...
/* harmony import */ var _equipment_vue_vue_type_style_index_0_id_459c23e0_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./equipment.vue?vue&type=style&index=0&id=459c23e0&scoped=true&lang=css& */ 125);
...
var _default = {
  ...
  onLoad: function onLoad() {
    ...
    this.applyForm.appointmentTime = "".concat(year, "-").concat(month, "-").concat(day);
  },
  methods: {
    loadEquipmentList: function loadEquipmentList() {
      var _this = this;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return _api.equipmentService.getServiceTypes();
              case 4:
                res = _context.sent;
                if (res.code === 200) {
              ...
              case 8:
                ...
                console.error('加载设备列表失败:', _context.t0);
                uni.showToast({
                  title: '加载失败',
                  icon: 'none'
                });
        ...
        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                applyData = {
                  serviceTypeId: _this2.selectedEquipment.id,
                  serviceContent: _this2.applyForm.serviceContent,
                  appointmentTime: _this2.applyForm.appointmentTime,
                  address: _this2.applyForm.address,
                  contactPhone: _this2.applyForm.contactPhone
                };
                _context2.prev = 4;
                uni.showLoading({
                  title: '提交中...'
                ...
                _context2.next = 8;
                return _api.equipmentService.applyService(applyData);
              case 8:
                res = _context2.sent;
                if (res.code === 200) {
                  uni.showToast({
              ...
              case 12:
                ...
                console.error('提交申请失败:', _context2.t0);
                uni.showToast({
                  title: '提交失败',
                  icon: 'none'
                });
    ...
    validateForm: function validateForm() {
      return this.selectedEquipment && this.applyForm.serviceContent && this.applyForm.address && this.applyForm.contactPhone && this.applyForm.appointmentTime;
    },
